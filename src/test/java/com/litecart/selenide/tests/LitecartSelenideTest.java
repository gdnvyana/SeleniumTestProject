...
@Epic("Litecart Интернет-магазин")
...
public class LitecartSelenideTest extends BaseTest {
    ...
    @Test(priority = 1)
    @Story("Авторизация")
    @Description("Тест проверяет возможность входа в систему с валидными учетными данными")
    ...
    @Test(priority = 2)
    @Story("Корзина")
    @Description("Тест проверяет добавление одного товара в корзину")
    ...
    @Test(priority = 3)
    @Story("Корзина")
    @Description("Тест проверяет добавление нескольких товаров в корзину")
    @Severity(SeverityLevel.BLOCKER)
    ...
    @Test(priority = 4)
    @Story("Навигация")
    @Description("Тест проверяет открытие категории Rubber Ducks")
    ...
    @Test(priority = 5)
    @Story("Детали товара")
    @Description("Тест проверяет отображение деталей товара")
    @Severity(SeverityLevel.NORMAL)
